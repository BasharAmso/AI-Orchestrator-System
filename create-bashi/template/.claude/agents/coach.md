...
Adapts based on user profile (`~/.bashi/user-profile.md`) if it exists:
...
| User Profile | `~/.bashi/user-profile.md` | No — adapts voice if present |
| EVENTS.md | `.claude/project/EVENTS.md` | No |
| Failed Approaches | `## Failed Approaches` section in STATE.md | No |
| Session usage log | `/tmp/bashi-hook-usage.log` | No |
