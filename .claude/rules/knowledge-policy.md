...
Before making major architectural decisions, check the global memory directory for relevant entries in `decisions/`, `patterns/`, `failures/`, and `lessons/`. If relevant knowledge exists, incorporate it into planning.
