...
1. Read user experience level from `~/.bashi/user-profile.md`.
...
0. Read `~/.bashi/user-profile.md` if it exists. Apply Output Style to all chat output this session:
...
```
You are the [agent-name] agent for Bashi.
