...
Read `TEMPLATE.md` in this skill folder for the GDD structure. Use exact section headings (downstream skills depend on them). The template contains all 14 required sections:

1. Game Identity
2. Core Fantasy
3. Design Pillars (+ Anti-Pillars)
4. Gameplay Loops (4 timescales + Win/Lose)
5. Core Mechanics
6. Progression & Economy
7. Player Experience (MDA, Bartle, SDT)
8. Art Direction
9. Audio Direction
10. MVP Scope (MoSCoW prioritized)
11. NOT in Scope
12. Risks & Assumptions (+ Kill Rule)
13. Open Questions
14. References

Scope posture adjustments are documented at the bottom of TEMPLATE.md.
...
| Field | Value |
|-------|-------|
| **Artifacts** | `docs/GDD.md` (created or updated with all 14 sections) |
| **State Update** | `.claude/project/STATE.md` — mark task complete, log files modified |
| **Decision Log** | `.claude/project/knowledge/DECISIONS.md` — design pillars, scope posture, key game design decisions |
| **Handoff Event** | `GDD_UPDATED` (GDD ready for task breakdown) |
